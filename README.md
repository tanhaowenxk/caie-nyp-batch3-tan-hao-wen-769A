...
**Key Takeaways:**
Across all three models, the XGBoost classifier emerges as the best choice when prioritizing the balanced F1-score, while still maintaining strong discrimination ability:
